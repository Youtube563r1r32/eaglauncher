...
function dogomobile() {
    ...
    document.getElementById('playbutton').href = 'https://irv77.github.io/EaglerPocketMobile/demo/';
}
...
function astraclient() {
    ...
    document.getElementById('playbutton').href = 'https://astraclientorg.github.io/';
}
...
function starlike() {
    ...
    document.getElementById('playbutton').href = 'https://starlike.zumbiepig.dev/wasm.html';
}
...
function resentclient() {
    ...
    document.getElementById('playbutton').href = 'https://resent4-0.vercel.app/';
}
...
function shadowclient() {
    ...
    document.getElementById('playbutton').href = 'https://peytonplayz595.github.io/Shadow-4.0/javascript/';
}
...
function latestrelease() {
    ...
    document.getElementById('playbutton').href = 'https://eaglercraft.com/mc/1.8.8-wasm/';
}
...
function previousrelease() {
    ...
    document.getElementById('playbutton').href = 'https://eaglercraft.com/mc/1.5.2/';
}
